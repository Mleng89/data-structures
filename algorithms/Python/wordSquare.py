...
First, design a way to return true if a given sequence of words
is a word square.

Second, given an arbitrary list of words, return all the possible
word squares it contains.
...
wordSquare(["AREA", "BALL", "DEAR", "LADY", "LEAD", "YARD"])
